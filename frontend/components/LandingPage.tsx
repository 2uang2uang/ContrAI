    ...
    useEffect(() => {
        ...
        const render = () => {
            ...
            points.forEach((point) => {
                ...
                const z =
                    point.z * Math.cos(rotation) + point.x * Math.sin(rotation);
                const y = point.y;
            ...
            <a href="#" className="flex items-center gap-3">
                <div className="relative group cursor-pointer">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <span className="text-[10px] font-bold text-grey-900 dark:text-white font-mono">
                            CA
                        </span>
                    </div>
                </div>
...
const FeatureCard = ({
    ...
    >
        ...
        <div className="relative z-10">
            ...
            <p className="text-grey-500 dark:text-grey-400 text-base leading-relaxed">
                {desc}
            </p>
        </div>
    </motion.div>
                ...
                <div className="relative z-10 container mx-auto px-6 lg:px-12 flex flex-col items-center text-center">
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="italic text-grey-500 dark:text-grey-400">
                                reputation systems,
                            </span>{" "}
                            <br />
                ...
                <div className="container mx-auto px-6 lg:px-12">
                    <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
                        ...
                        >
                            ...
                            <p className="text-grey-500 dark:text-grey-400 max-w-md text-lg">
                                Our proprietary algorithm analyzes on-chain
                                pallets to build a comprehensive identity
                                profile.
                            </p>
                        </motion.div>
                        ...
                        {[
                            {
                                icon: Globe,
                                title: "Connect",
                                desc: "Securely link your Polkadot wallet. No registration required, just pure Web3 authentication.",
                            },
                            {
                                icon: Zap,
                                title: "Analyze",
                                desc: "Our AI engine scans Identity, Staking, and Governance pallets to reconstruct your activity history.",
                            },
                            {
                                icon: Layers,
                                title: "Rank",
                                desc: "Receive your real-time score, mint your reputation badge, and climb the ecosystem leaderboard.",
                            },
                        ].map((item, i) => (
                            <motion.div
                                key={i}
            ...
            <footer className="py-12 border-t border-grey-200 dark:border-grey-800 bg-grey-50 dark:bg-grey-950 relative transition-colors duration-300">
                <div className="container mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-grey-500 dark:text-grey-500 font-sans text-sm">
                            © 2026 ContrAI Network
                        </span>
                    </div>
